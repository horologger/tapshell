...
echo "Create Wallet" 
echo "lncli --rpcserver=localhost:10019 --tlscertpath=/data/node_a/lnd/tls.cert create"
echo "Stop LND with Ctrl-C"
echo "Create lndcli Alias"
echo "alias lncli='lncli --rpcserver=localhost:10019 --tlscertpath=/data/node_a/lnd/tls.cert --macaroonpath=/data/node_a/lnd/data/chain/bitcoin/mainnet/admin.macaroon'"
echo "alias lncli='lncli --rpcserver=localhost:10029 --tlscertpath=/data/node_b/lnd/tls.cert --macaroonpath=/data/node_b/lnd/data/chain/bitcoin/mainnet/admin.macaroon'"
echo "...create pwd file"
...
echo "Create tapcli Alias"
echo "alias tapcli='tapcli --rpcserver=localhost:10019 --tlscertpath=/data/node_a/lnd/tls.cert --macaroonpath=/data/node_a/tapd/admin.macaroon'"
echo "tapcli getinfo"
echo "Create litcli Alias"
echo "alias litcli='litcli --rpcserver=localhost:8444 --tlscertpath=/data/node_a/lit/tls.cert --macaroonpath=/data/node_a/lit/lit.macaroon'"
echo "litcli getinfo"
